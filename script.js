...
var logColors = function () {
    // Get the current hour using 'dayjs' library withc is getting the hours of the day
  ...
  // Call the 'logColors' function
  logColors();
  
  // Output the 'logColors' function to the console
...
function saveTasksToLocalStorage() {
  ...
  setInterval(updateLiveTime, 1000);
    ...
    //this works but does not store localstorage in array
